...
export function PianoRoll({ clip, onClose }: PianoRollProps) {
  const { addNote, removeNote, moveNote, getNoteNameFromPitch } = useMidiEditor()
  ...
  const handleGridClick = (e: React.MouseEvent) => {
    ...
    const x = e.clientX - gridRef.current.offsetLeft + gridRef.current.scrollLeft
    const y = e.clientY - gridRef.current.offsetTop + gridRef.current.scrollTop
